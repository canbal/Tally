...
This content is released under the [MIT License](https://github.com/canbal/Tally/blob/master/LICENSE). For any documented use of our software in reports, publications, etc., we ask that you cite our paper [1].  If you want to cite the Tally website, please use [2].
