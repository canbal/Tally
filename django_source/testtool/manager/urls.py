...
urlpatterns = patterns('testtool.manager.views',
    ...
    url(r'^tests/(?P<test_id>\d+)/share$',          'share_export_obj',    {'action':'share'},   name='share_test'),
    url(r'^tests/(?P<test_id>\d+)/export$',         'share_export_obj',    {'action':'export'},  name='export_test'),
    url(r'^tests/(?P<test_id>\d+)/unshare$',        'unshare_delete_test', {'action':'unshare'}, name='unshare_test'),
    url(r'^tests/(?P<test_id>\d+)/delete$',         'unshare_delete_test', {'action':'delete'},  name='delete_test'),
    ...
    url(r'^tests/(?P<test_id>\d+)/instances/(?P<test_instance_id>\d+)/share$',   'share_export_obj',      {'action':'share'},  name='share_test_instance'),
    url(r'^tests/(?P<test_id>\d+)/instances/(?P<test_instance_id>\d+)/export$',  'share_export_obj',      {'action':'export'}, name='export_test_instance'),
    url(r'^tests/(?P<test_id>\d+)/instances/(?P<test_instance_id>\d+)/unshare$', 'unshare_delete_test_instance',  {'action':'unshare'}, name='unshare_test_instance'),
    url(r'^tests/(?P<test_id>\d+)/instances/(?P<test_instance_id>\d+)/delete$',  'unshare_delete_test_instance',  {'action':'delete'}, name='delete_test_instance'),
