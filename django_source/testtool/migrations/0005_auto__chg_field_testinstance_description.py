...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TestInstance.description'
        db.alter_column('testtool_testinstance', 'description', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'TestInstance.description'
        db.alter_column('testtool_testinstance', 'description', self.gf('django.db.models.fields.CharField')(max_length=400))
