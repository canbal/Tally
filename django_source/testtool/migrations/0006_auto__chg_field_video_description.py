...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('testtool_video', 'description', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Video.description'
        db.alter_column('testtool_video', 'description', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))
    ...
    models = {
        ...
        'testtool.video': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'default': "'dfa'", 'blank': 'True'}),
