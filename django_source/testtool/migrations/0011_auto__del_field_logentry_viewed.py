...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LogEntry.viewed'
        db.delete_column('testtool_logentry', 'viewed')

        # Adding M2M table for field viewed on 'LogEntry'
        db.create_table('testtool_logentry_viewed', (
        ...
        db.create_unique('testtool_logentry_viewed', ['logentry_id', 'userprofile_id'])


    def backwards(self, orm):
        # Adding field 'LogEntry.viewed'
        db.add_column('testtool_logentry', 'viewed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Removing M2M table for field viewed on 'LogEntry'
        db.delete_table('testtool_logentry_viewed')
    ...
    models = {
        ...
        'testtool.logentry': {
            ...
            'viewed': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'viewed_logentries'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['testtool.UserProfile']"})
        },
        'testtool.scoredscqs': {
